...
async function createDirectoryStructure(projectPath, options) {
	...
	try {
		...
		packageJson.bin[`bamimi-enjoy-${projectName}`] = packageJson.bin[`bamimi-enjoy-`]
		packageJson.bin[`bamimi-enjoy-${projectName}-dev`] = packageJson.bin[`bamimi-enjoy-dev`]
		delete packageJson.bin[`bamimi-enjoy-`]
		delete packageJson.bin[`bamimi-enjoy-dev`]
		...
		await fs.writeFile(envExampleFilePath, envFile)
